    ...
    public static class NinjectWebCommon 
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            try
            {
                ...
                //controller factory'i -dependecy resolver'ý- ninject ile yapacaðýmýzý söylüyoruz.
        ...
        {
            //ninject module api için
            kernel.Load(new BusinnesModule(),new AutoMapperModule());
        }
    }
}